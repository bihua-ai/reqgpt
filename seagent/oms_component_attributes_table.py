...
if not _RELEASE:
    ...
    # folder destination is /opt/bihua/reqgpt/seagent/component-template/template/st_attributes_component/frontend
    parent_dir = os.path.dirname(os.path.abspath(__file__))
    build_dir = os.path.join(parent_dir, "component-template/template/st_attributes_component/frontend/build")
    _component_func = components.declare_component("st_attributes_component", path=build_dir)



def st_attributes_component(variable_identifier, spec_json, key=None, default=None):
    """Create a new instance of "st_attributes_component"."""
