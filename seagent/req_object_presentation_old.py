...
def object_page(action_identifier, spec_json_path):
    ...
    with st.sidebar:
        ...
        if st.session_state.user_id:
            ...
            print(f"object page = {return_node}")
    ...
    if selected_name is not None:
        if selected_name != action_name:
            ...
            spec_json_string = json.dumps(spec_json)
            return_car_element  = req_action_table_component.st_action_component(action_identifier, variable_list_json_string, spec_json_string, key="action_car_table")
